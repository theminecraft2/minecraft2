...
execute at @e[type=item,nbt={Item: {id: "minecraft:iron_helmet"}}] if entity @e[type=item,nbt={Item: {id: "minecraft:iron_ingot", tag: {Tags: ["mc2_wooden_metal_ingot"]}, Count: 5b}}] if block ~ ~-1 ~ minecraft:smithing_table run function minecraft2:drofts/item/armor/wooden_metal/helmet

execute at @e[type=item,nbt={Item: {id: "minecraft:iron_chestplate"}}] if entity @e[type=item,nbt={Item: {id: "minecraft:iron_ingot", tag: {Tags: ["mc2_wooden_metal_ingot"]}, Count: 8b}}] if block ~ ~-1 ~ minecraft:smithing_table run function minecraft2:drofts/item/armor/wooden_metal/chestplate

execute at @e[type=item,nbt={Item: {id: "minecraft:iron_leggings"}}] if entity @e[type=item,nbt={Item: {id: "minecraft:iron_ingot", tag: {Tags: ["mc2_wooden_metal_ingot"]}, Count: 7b}}] if block ~ ~-1 ~ minecraft:smithing_table run function minecraft2:drofts/item/armor/wooden_metal/leggings

execute at @e[type=item,nbt={Item: {id: "minecraft:iron_boots"}}] if entity @e[type=item,nbt={Item: {id: "minecraft:iron_ingot", tag: {Tags: ["mc2_wooden_metal_ingot"]}, Count: 4b}}] if block ~ ~-1 ~ minecraft:smithing_table run function minecraft2:drofts/item/armor/wooden_metal/boots
