...
execute at @e[tag=goblin,nbt=!{Motion: [0.0d, 0.0d, 0.0d]}] run playsound minecraft:block.grass.step ambient @p ~ ~ ~ 1
execute at @e[tag=goblin,nbt=!{HurtTime:0s}] run playsound minecraft:entity.villager.hurt hostile @p ~ ~ ~ 1